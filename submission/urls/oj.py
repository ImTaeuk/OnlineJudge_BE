...
from ..views.oj import SubmissionAPI, SubmissionListAPI, ContestSubmissionListAPI, SubmissionExistsAPI, SubmissionVisualDataResultAPI
...
urlpatterns = [
    ...
    url(r"^submission_visual/?$", SubmissionVisualDataResultAPI.as_view(), name="submission_visual"),
]
