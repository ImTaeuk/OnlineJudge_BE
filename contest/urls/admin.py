...
from ..views.admin import ContestAnnouncementAPI, ContestAPI, ACMContestHelper, DownloadContestSubmissions, ContestStudentIdAPI

urlpatterns = [
    url(r"^contest/student_id/?$", ContestStudentIdAPI.as_view(), name="contest_student_id_api"),
